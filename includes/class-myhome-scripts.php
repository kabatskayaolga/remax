...
//			if ( is_page_template( 'page_panel.php' ) ) {
//				wp_enqueue_script( 'myhome-panel-2', get_template_directory_uri() . '/assets/js/panel2.js', array(), false, true );
//				wp_enqueue_style( 'myhome-panel-2-fonts', 'https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Material+Icons' );
//				wp_enqueue_style( 'myhome-panel-2', 'https://unpkg.com/vuetify/dist/vuetify.min.css' );
//			}
